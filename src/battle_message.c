...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_ONETYPECAPTUREBLOCKED]                = gText_OneTypeChallengeCantThrowPokeBall,
    [STRINGID_NUZLOCKECAPTUREBLOCKED]               = gText_NuzlockeCantThrowPokeBallRoute,
    [STRINGID_SPECIESCLAUSECAPTUREBLOCKED]          = gText_NuzlockeCantThrowPokeBallSpeciesClause,
    [STRINGID_SAMESPECIESCAPTUREBLOCKED]            = gText_NuzlockeCantThrowPokeBallAlreadyCaught,
...
static const u8 sText_May2ndBattleHpLow[] = _("Woah, you got pretty strong {B_PLAYER_NAME}!\p");
...
static const u8 sText_MaxieMega[] = _("Maxie: Heh, we aren't done yet.\p");
