...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_FLOETTE_ ##FORM##_FLOWER})
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_SLIGGOO},
    ...
    [SPECIES_SLIGGOO_HISUIAN] =
    {
        ...
        .formSpeciesIdTable = sSliggooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL_RAIN, 45, SPECIES_GOODRA_HISUIAN},
                                {EVO_LEVEL_FOG, 45, SPECIES_GOODRA_HISUIAN}),
    },
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 36, SPECIES_AVALUGG},
                                {EVO_LEVEL_NIGHT, 36, SPECIES_AVALUGG_HISUIAN}),
    },
    ...
    [SPECIES_AVALUGG_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = BERGMITE_EGG_GROUPS,
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ICE_BODY, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Avalugg"),
        .cryId = CRY_AVALUGG,
        .natDexNum = NATIONAL_DEX_AVALUGG,
