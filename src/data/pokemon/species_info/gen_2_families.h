...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_TOXIC_DEBRIS, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_RED,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_PRANKSTER },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_PINECO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_FORRETRESS}),
    },
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_URSARING}),
    },
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 100 : 85)
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_TECHNICIAN, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_PUPITAR}),
    },
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 47, SPECIES_TYRANITAR}),
    },
    ...
    [SPECIES_HO_OH] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_PRESSURE, ABILITY_REGENERATOR, ABILITY_GOOD_AS_GOLD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Ho-Oh"),
        .cryId = CRY_HO_OH,
