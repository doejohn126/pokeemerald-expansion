...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_FLOETTE_ ##FORM})
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_AVALUGG, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 36, SPECIES_AVALUGG_HISUI, CONDITIONS({IF_TIME, TIME_NIGHT})}),
    },
