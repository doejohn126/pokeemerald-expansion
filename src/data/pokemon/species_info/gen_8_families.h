...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DOTTLER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_ORBEETLE}),
    },
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BALL_FETCH, ABILITY_RATTLED, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOLTUND] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_RATTLED, ABILITY_DEFIANT },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_APPLETUN] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_RIPEN, ABILITY_GLUTTONY, ABILITY_WELL_BAKED_BODY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HATENNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_HATTREM}),
    },
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_MORGREM}),
    },
    ...
    [SPECIES_MORGREM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_GRIMMSNARL}),
    },
    ...
    [SPECIES_MILCERY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_STRAWBERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_VANILLA_CREAM},
                                {EVO_ITEM, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_STRAWBERRY_RUBY_CREAM},
                                {EVO_ITEM, ITEM_CLOVER_SWEET, SPECIES_ALCREMIE_STRAWBERRY_MATCHA_CREAM},
                                {EVO_ITEM, ITEM_BERRY_SWEET, SPECIES_ALCREMIE_STRAWBERRY_MINT_CREAM},
                                {EVO_ITEM, ITEM_STAR_SWEET, SPECIES_ALCREMIE_STRAWBERRY_LEMON_CREAM},
                                {EVO_LEVEL, 0, SPECIES_ALCREMIE_STRAWBERRY_SALTED_CREAM},
                                {EVO_LEVEL, 0, SPECIES_ALCREMIE_STRAWBERRY_RUBY_SWIRL},
                                {EVO_ITEM, ITEM_FLOWER_SWEET, SPECIES_ALCREMIE_STRAWBERRY_CARAMEL_SWIRL},
                                {EVO_ITEM, ITEM_LOVE_SWEET, SPECIES_ALCREMIE_STRAWBERRY_RAINBOW_SWIRL}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_STONJOURNER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_ROCKY_PAYLOAD, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DREEPY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_DRAKLOAK}),
    },
