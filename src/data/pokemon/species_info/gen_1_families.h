...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_SOLAR_POWER, ABILITY_DRAGONS_MAW },
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    {
        .baseHP        = 35,
        .baseAttack    = P_UPDATED_STATS >= GEN_7 ? 110 : 80,
        .baseDefense   = 50,
        .baseSpeed     = 130,
    ...
    [SPECIES_MEOWTH] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PICKUP, ABILITY_TECHNICIAN, ABILITY_FELINE_POWESS },
    #else
    ...
    [SPECIES_PERSIAN] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LIMBER, ABILITY_TECHNICIAN, ABILITY_FELINE_POWESS },
    #else
    ...
    [SPECIES_PERSIAN_ALOLA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FUR_COAT, ABILITY_TECHNICIAN, ABILITY_FELINE_POWESS },
        .bodyColor = BODY_COLOR_GRAY,
        .speciesName = _("Persian"),
        .cryId = CRY_PERSIAN,
        .natDexNum = NATIONAL_DEX_PERSIAN,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_POLIWHIRL}),
    },
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 33, SPECIES_RAPIDASH}),
    },
...
#define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE}
    ...
    [SPECIES_KINGLER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_HYPER_CUTTER, ABILITY_ANGER_SHELL, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
        .noFlip = TRUE,
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SAND_FORCE, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 29, SPECIES_SEADRA}),
    },
