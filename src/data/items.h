...
// Poké Balls
    ...
    {
        .name = _("Sport Ball"),
        .price = (I_PRICE < GEN_3 || I_PRICE >= GEN_9) ? 600 : 300,
        .description = COMPOUND_STRING(
            "A special Ball\n"
            "used in the Bug-\n"
            "Catching Contest."),
...
// Evolution Items
    ...
    {
        .name = _("Electirizer"),
        .price = (I_PRICE >= GEN_7) ? 4000 * TREASURE_FACTOR : 4100,
        .description = COMPOUND_STRING(
            "Loved by a certain\n"
            "Pokémon. It's full\n"
            "of electric energy."),
...
// Species-specific Held Items
    ...
    {
        .name = _("Soul Dew"),
        .price = (I_PRICE >= GEN_7) ? 25000 : 25000,
...
// Type-boosting Held Items
    ...
    {
        .name = _("Metal Coat"),
        .price = (I_PRICE >= GEN_9) ? 5500 : ((I_PRICE >= GEN_7) ? 5500 : 100),
