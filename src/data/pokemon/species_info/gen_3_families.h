...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .formSpeciesIdTable = sZigzagoonFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_LINOONE_GALAR}),
    },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_FRISK, ABILITY_RAIN_DISH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_NINCADA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_NINJASK, 19, SPECIES_NINJASK},
                                {EVO_LEVEL_SHEDINJA, 19, SPECIES_SHEDINJA}),
    },
    ...
    [SPECIES_PROBOPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STURDY, ABILITY_THERMAL_EXCHANGE, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_ARON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_LAIRON}),
    },
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_STICKY_HOLD, ABILITY_CUD_CHEW },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, ABILITY_TOXIC_DEBRIS, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_DUSCLOPS] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_HUSTLE, ABILITY_FRISK },
    #else
    ...
    [SPECIES_DUSKNOIR] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_PRESSURE, ABILITY_HUSTLE, ABILITY_LEVITATE },
    #else
        .abilities = { ABILITY_PRESSURE, ABILITY_NONE, ABILITY_NONE },
    #endif
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_STAKEOUT, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_SPHEAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_SEALEO}),
    },
    ...
    [SPECIES_BAGON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_SHELGON}),
    },
