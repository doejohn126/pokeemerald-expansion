...
} static const sItemFunctionsMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BIKESURF]     = {DrawChoices_BikeSurf,  ProcessInput_Options_Two},
...
static const u8 *const sOptionMenuItemsNamesMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BIKESURF]  = gText_OptionSurfBike,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_MAIN:
        ...
        case MENUITEM_MAIN_BIKESURF:      return TRUE;
...
static const u8 *const sOptionMenuItemDescriptionsMain[MENUITEM_MAIN_COUNT][3] =
{
    ...
    [MENUITEM_MAIN_BIKESURF]  = {sText_Desc_SurfOn,           sText_Desc_SurfOff,   sText_Empty},
...
static const u8 *const sOptionMenuItemDescriptionsDisabledMain[MENUITEM_MAIN_COUNT] =
{
    ...
    [MENUITEM_MAIN_BIKESURF]  = sText_Empty,
...
static const u8 *const OptionTextDescription(void)
{
    ...
    {
    case MENU_MAIN:
        if (!CheckConditions(menuItem) && sOptionMenuItemDescriptionsDisabledMain[menuItem] != sText_Empty)
...
void CB2_InitOptionPlusMenu(void)
{
    ...
    case 6:
        ...
        sOptions->sel[MENUITEM_MAIN_BIKESURF]  = gSaveBlock2Ptr->optionsDisableBikeAndSurfMus;
...
static void Task_OptionMenuSave(u8 taskId)
{
    ...
    gSaveBlock2Ptr->optionsDisableBikeAndSurfMus  = sOptions->sel[MENUITEM_MAIN_BIKESURF];
...
static void DrawChoices_PokedexTheme(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_POKEDEXTHEME);
    u8 styles[2] = {0};
    styles[selection] = 1;

    DrawOptionMenuChoice(sText_Dark, 104, y, styles[0], active);
...
static void DrawChoices_BikeSurf(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_MAIN_BIKESURF);
    u8 styles[2] = {0};
    styles[selection] = 1;
