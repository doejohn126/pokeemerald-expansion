    ...
    case ABILITY_BATTLE_BOND:
        {
            ...
            if (GetGenConfig(GEN_CONFIG_BATTLE_BOND) < GEN_9 && gBattleMons[battlerAtk].species == SPECIES_GRENINJA)
            {
                // TODO: Convert this to a proper FORM_CHANGE type.
                gLastUsedAbility = abilityAtk;
            ...
            if (gSaveBlock1Ptr->tx_Challenges_BaseStatEqualizer)
                {
                    ...
                    gBattleStruct->moveDamage[gBattlerTarget] = baseStat[gSaveBlock1Ptr->tx_Challenges_BaseStatEqualizer];
                }
            else
