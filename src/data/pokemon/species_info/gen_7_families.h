...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE, CONDITIONS({IF_TIME, TIME_NIGHT})},
                                {EVO_LEVEL, 34, SPECIES_DECIDUEYE_HISUI, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
    ...
    [SPECIES_YUNGOOS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_GUMSHOOS, CONDITIONS({IF_NOT_TIME, TIME_NIGHT})}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_JANGMO_O] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_HAKAMO_O}),
    },
    ...
    [SPECIES_MELTAN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 61, SPECIES_MELMETAL}),
    },
